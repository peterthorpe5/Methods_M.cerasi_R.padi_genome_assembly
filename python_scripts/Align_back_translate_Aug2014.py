...
* https://github.com/PATH_TOjc/pico_galaxy/tree/master/tools/align_back_trans

This tool is available with a Galaxy wrapper from the Galaxy Tool Shed at:

* http://toolshed.g2.bx.psu.edu/view/PATH_TOjc/align_back_trans

See accompanying text file for licence details (MIT licence).

This is version 0.0.5 of the script.
"""
import os
import sys
