...
# Title: script to remove contigs not wanted from a fasta file
...
def seq_getter(filename_in, wantedfile, outfile):
    """Funtion to remove the not wanted names from a given fasta file"""
    f = open(outfile, 'w')
...
if __name__ == '__main__':
    # in.fasta names_not_wanred, out.fasta
